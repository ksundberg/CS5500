...
MiniMapCamera::MiniMapCamera(float x, float y, float z)
{
  ...
  //lack of rotate function intentionally left out due to mini map being constant stable
...
//this is where we will recieve a value of density of the requested element and provide a gui that is like a heat map
